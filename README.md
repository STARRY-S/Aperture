...
HackWeek 21 project: [Aperture: a simple game engine written in C based on OpenGL](https://hackweek.opensuse.org/21/projects/aperture-a-simple-game-engine-written-in-c-based-on-opengl)
