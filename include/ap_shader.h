...
/**
 * @brief Shader struct object definition of Aperture
 */
struct AP_Shader {
        // id is the shader ID of Aperture engine
        // should be used for ap_shader_* function
        unsigned int id;
        // opengl_program_id is the ID generated by OpenGL
        // can be used by glUseProgram()
        unsigned int opengl_program_id;
...
int ap_shader_set_float(const char *const name, float num);

int ap_shader_set_int  (const char *const name, GLuint num);
